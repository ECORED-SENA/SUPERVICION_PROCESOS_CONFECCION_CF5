...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4 Para realizar el trazo es importante tener en cuenta la orientación de la tela y el aplome de los moldes, cuáles piezas van a lo largo o en sentido de la urdimbre, y cuáles van a través, o sea, en sentido de la trama. También hay piezas que se deben dibujar en diagonal como es el caso de los sesgos.
    p.mb-4 El aprovechamiento adecuado de los materiales es el resultado de elaborar un buen trazo, ya que está directamente relacionado con el aprovechamiento y/o desperdicio del recurso, que, en la mayoría de los casos, representa el mayor porcentaje del costo de la prenda.
    p.mb-4 Este procedimiento de trazo se puede realizar de manera manual o mediante un software, en el mercado hay numerosas ofertas de estos programas como pueden ser:
    ...
    #t_2_2.titulo-segundo
      .h4 2.2 Elementos y equipos para trazar
    
    p.mb-4 A continuación, se presentan las diferencias más relevantes entre el proceso de trazo manual y el sistematizado:
    ...
    #t_2_3.titulo-segundo
      .h4 2.3 Área de la sección de trazo y corte
    ...
    #t_2_4.titulo-segundo
      .h4 2.4 Ingreso, recepción, almacenamiento y reposo de telas
    
    p.mb-4 A la sección de trazo y corte entra gran cantidad de recursos, entre ellos, información necesaria para programar actividades que permitan cumplir con los objetivos. Esta información tiene que ver con:
    ...
    #t_2_5.titulo-segundo
      .h4 2.5 Planeación del área de trazo y corte
    ...
    #t_2_6.titulo-segundo
      .h4 2.6 Almacenamiento

    .row.justify-content-center
      .col-md-3.d-flex.mb-4.mb-md-0
        .tarjeta.color-light-green.p-4
    ...
    .tarjeta.color-light-green.mb-4
      .row.justify-content-center.p-4
        .col-md-4.mb-4.mb-md-0
